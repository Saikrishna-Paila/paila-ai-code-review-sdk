...
║      📊 CODE REVIEW SUMMARY          ║
╠══════════════════════════════════════╣
║  Score: {result.score:>3}/100  Grade: {result.grade:<10}   ║
║  Files: {len(result.files):>3}      Issues: {result.total_issues:<10}  ║
╚══════════════════════════════════════╝
""")
```
...
[![Star](https://img.shields.io/badge/⭐_Star_on_GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/saikrishnapaila/paila)
...
<img src="https://img.shields.io/badge/Project_3_of_12-12_AI_Projects_2025-blueviolet?style=flat-square" alt="Project 3 of 12"/>
